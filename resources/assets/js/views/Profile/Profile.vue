  ...
  <div class="centered"><h2>{{user.name}}</h2></div>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
		  ...
		  <hr>
			<small><h4>Interests:</h4> {{user.skill}}</small>
		  <hr>
		  ...
		  <a :href="user.fb" title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a>
		  <a :href="user.insta" title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a>
		  <a :href="user.twitter" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a>
		  <a :href="user.gmail" title="Google+" target="_blank"><i class="fa fa-google-plus"></i></a>
		  <a href="'https://'+user.lin" title="LinkedIn+" target="_blank"><i class="fa fa-linkedin"></i></a>
		  <a :href="user.b" title="LinkedIn+" target="_blank"><i class="fa fa-behance"></i></a>
				
				<!--<a href="{{user.fb}}" title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a>
		  <a href="{{user.insta}}" title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a>
		  <a href="{{user.twiiter}}" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a>
		  <a href="{{user.gmail}}" title="Google+" target="_blank"><i class="fa fa-google-plus"></i></a>
		  <a href="{{user.lin}}" title="LinkedIn+" target="_blank"><i class="fa fa-linkedin"></i></a>
		  <a href="{{user.b}}" title="LinkedIn+" target="_blank"><i class="fa fa-behance"></i></a>-->
